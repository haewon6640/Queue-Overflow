...
export default class EditQuestionForm extends React.Component {
  ...
  handleSubmit(e) {
    ...
    this.props
      .action(this.state)
      .then((res) => this.props.history.push(`/questions/${res.post.id}`));
  }
            ...
            <aside className="steps-container">
              ...
              <div className="steps">
                ...
                <ul className="steps-instruction">
                  <li>
                    <span className="number">1.</span> Summarize the problem.
                  </li>
                  <li>
                    <span className="number">2.</span> Describe what you've
                    tried.
                  </li>
                  <li>
                    <span className="number">3.</span> Show some code.
                  </li>
                </ul>
              </div>
            </aside>
